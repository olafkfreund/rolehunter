...
| v3.2 | Company intel | `companies` table, Glassdoor reviews via Apify, layoffs.fyi, news, connection paths | [#43](https://github.com/olafkfreund/rolehunter/issues/43) |
...
| v3.4 | Interview deepened | mock interviews, spaced-repetition gap drills, per-company behavioral bank | [#45](https://github.com/olafkfreund/rolehunter/issues/45) |
| v3.5 | Signals & negotiation | notifications, offer tracking, salary negotiation log, outreach tracker | [#46](https://github.com/olafkfreund/rolehunter/issues/46) |
